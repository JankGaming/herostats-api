...
app.get('/', function(req, res) {
  ...
  var welcomeMsg = '<!DOCTYPE html>' +
    ...
    'For a single hero, query http://api.herostats.io/heroes/<strong>heroname</strong><br /><br />' +
    'You can query with the JankDota HeroID with http://api.herostats.io/heroes/<strong>heroID</strong><br /><br />' +
    '<strong>To get ALL hero data in one query</strong>, use http://api.herostats.io/heroes/all<br /><br />' +
    '<strong>To get ALL hero data for a given patch</strong>, ' +
    'use http://api.herostats.io/patch/<strong>patch number</strong><br />' +
